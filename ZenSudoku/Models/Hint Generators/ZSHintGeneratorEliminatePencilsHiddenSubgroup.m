...
@interface ZSHintGeneratorEliminatePencilsHiddenSubgroup () {
	...
	ZSHintGeneratorEliminatePencilsHiddenSubgroupInstruction *_groupTiles;
	ZSHintGeneratorEliminatePencilsHiddenSubgroupInstruction *_subGroupTiles;
	ZSHintGeneratorEliminatePencilsHiddenSubgroupInstruction *_pencilsToEliminate;
...
- (void)_allocTilesAndInstructionsWithSubgroupSize:(NSInteger)size {
	...
	_groupTiles = malloc(sizeof(ZSHintGeneratorEliminatePencilsHiddenSubgroupInstruction) * 9 * 3);
	_subGroupTiles = malloc(sizeof(ZSHintGeneratorEliminatePencilsHiddenSubgroupInstruction) * size * 3);
	_pencilsToEliminate = malloc(sizeof(ZSHintGeneratorEliminatePencilsHiddenSubgroupInstruction) * 9 * 9 * 3);
...
- (NSArray *)generateHint {
	...
	for (NSInteger i = 0; i < _totalSubGroupTiles; ++i) {
		ZSHintGeneratorEliminatePencilsHiddenSubgroupInstruction *instruction = &_subGroupTiles[i];
	...
	for (NSInteger i = 0; i < _totalGroupTiles; ++i) {
		ZSHintGeneratorEliminatePencilsHiddenSubgroupInstruction *instruction = &_groupTiles[i];
	...
	for (NSInteger i = 0; i < _totalPencilsToEliminate; ++i) {
		ZSHintGeneratorEliminatePencilsHiddenSubgroupInstruction *instruction = &_pencilsToEliminate[i];
